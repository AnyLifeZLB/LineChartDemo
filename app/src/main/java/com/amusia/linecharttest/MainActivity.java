...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spData.add(new PieEntry(20, "前海", Color.parseColor("#00C11B")));
        spData.add(new PieEntry(45, "后海", Color.parseColor("#FFD006")));
        spData.add(new PieEntry(25, "深圳湾", Color.parseColor("#1B3CFF")));
        spData.add(new PieEntry(10, "宝安中心", Color.parseColor("#FF3721")));
